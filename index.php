    ...
    <body class="body-loading">
      <main id="main">
        ...
        <div id="files-container">
          <div id="files" class="list files-<?php echo Config::get('layout'); ?>"></div>
        </div>
      </main>
      ...
      <?php
            ...
            ]) as $key) echo '<script src="' . U::assetspath() . $key . '"></script>';
            echo '<script src="/files.js"></script>' . PHP_EOL;
      ?>
    </body>
          ...
          if ($action === 'files') {
            ...
            if (!empty($files)) {
              ...
              foreach ($files as $file) {
                ...
                break;
                exit; // just in case, although new FileResponse() will exit on U::readfile()
              }
            }
